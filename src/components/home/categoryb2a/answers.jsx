...
export default function B2aCategoryAnswers ({navigation}) {
    ...
    return (
        <GestureHandlerRootView style={{flex: 1, width: '100%'}}>
            ...
            <View style={styles.container}>
                ...
                {
                    number_question === 40 ? (    /**Function that allows you to repeat the exam  */    /**Function that allows you to repeat the exam  */    /**Function that allows you to repeat the exam  */    /**Function that allows you to repeat the exam  */

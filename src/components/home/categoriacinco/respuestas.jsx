...
export default function CategoriaCincoRespuestas ({navigation}) {
    ...
    return (
        <GestureHandlerRootView style={{flex: 1, width: '100%'}}>
            <BarraSuperiorRespuestas navigation={navigation} categoria={'CATEGORÍA 5 - A3B'} nro_categoria={nro_categoria} correcta={correcta_usuario}/>

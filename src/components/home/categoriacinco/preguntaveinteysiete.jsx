...
export default function PreguntaVeinteySieteScreen ({navigation}) {
    ...
    const siguiente_pregunta = () => {
        if (opcion === ''){
            ...
            navigation.navigate ('PreguntataCatCincoVeinteyOchoScreen')
        }
    }

    return (
        <GestureHandlerRootView style={{flex: 1, width: '100%'}}>
            <BarraSuperior navigation={navigation} nro_pregunta={27} categoria={'CATEGORÍA 5 - A3B'}/>

...
export default function PreguntaVeinteyUnoScreen ({navigation}) {
    ...
    const siguiente_pregunta = () => {
        if (opcion === ''){
            ...
            navigation.navigate ('PreguntataCatCincoVeinteyDosScreen')
        }
    }

    return (
        <GestureHandlerRootView style={{flex: 1, width: '100%'}}>
            <BarraSuperior navigation={navigation} nro_pregunta={21} categoria={'CATEGORÍA 5 - A3B'}/>

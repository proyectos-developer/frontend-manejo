...
export default function PreguntaTreintayTresScreen ({navigation}) {
    ...
    const siguiente_pregunta = () => {
        if (opcion === ''){
            ...
            navigation.navigate ('PreguntataCatCincoTreintayCuatroScreen')
        }
    }

    return (
        <GestureHandlerRootView style={{flex: 1, width: '100%'}}>
            <BarraSuperior navigation={navigation} nro_pregunta={33} categoria={'CATEGORÍA 5 - A3B'}/>

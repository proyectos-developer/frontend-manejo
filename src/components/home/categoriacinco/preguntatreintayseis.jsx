...
export default function PreguntaTreintaySeisScreen ({navigation}) {
    ...
    const siguiente_pregunta = () => {
        if (opcion === ''){
            ...
            navigation.navigate ('PreguntataCatCincoTreintaySieteScreen')
        }
    }

    return (
        <GestureHandlerRootView style={{flex: 1, width: '100%'}}>
            <BarraSuperior navigation={navigation} nro_pregunta={36} categoria={'CATEGORÍA 5 - A3B'}/>

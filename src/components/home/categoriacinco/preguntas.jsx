...
export default function CategoriaCincoPreguntas ({navigation}) {
    ...
    useEffect (() => {
        if (isFocused){
            ...
            dispatch(preguntasdata(preguntasConstants({}, false, id_pregunta, 'preguntas_categoria_cinco').get_pregunta))
        }
    }, [isFocused])
    ...
    const siguiente_pregunta = () => {
        if (opcion === ''){
            ...
            dispatch(preguntasdata(preguntasConstants({}, false, parseFloat(id_pregunta) + 1, 'preguntas_categoria_cinco').get_pregunta))
        }
    }
    ...
    const repetir_examen = () => {
        if (opcion !== ''){
            ...
            dispatch(preguntasdata(preguntasConstants({}, false, id_inicial, 'preguntas_categoria_cinco').get_pregunta))
        }
    }

    return (
        <GestureHandlerRootView style={{flex: 1, width: '100%'}}>
            <BarraSuperior navigation={navigation} categoria={'CATEGORÍA 5 - A3B'} nro_categoria={'preguntas_categoria_cinco'}/>

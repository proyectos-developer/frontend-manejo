...
export default function PreguntaVeinteyNueveScreen ({navigation}) {
    ...
    const siguiente_pregunta = () => {
        if (opcion === ''){
            ...
            navigation.navigate ('PreguntataCatCincoTreintaScreen')
        }
    }

    return (
        <GestureHandlerRootView style={{flex: 1, width: '100%'}}>
            <BarraSuperior navigation={navigation} nro_pregunta={29} categoria={'CATEGORÍA 5 - A3B'}/>

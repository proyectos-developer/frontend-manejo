...
export default function CategoriaCuatroRespuestas ({navigation}) {
    ...
    useEffect (() => {
        if (isFocused){
            dispatch(preguntasdata(preguntasConstants({}, false, id_pregunta, 'preguntas_categoria_cuatro').get_pregunta))
        }
    }, [isFocused])
    ...
    return (
        <GestureHandlerRootView style={{flex: 1, width: '100%'}}>
            <BarraSuperiorRespuestas navigation={navigation} categoria={'CATEGORÍA 4 - A3A'} nro_categoria={nro_categoria} correcta={correcta_usuario}/>

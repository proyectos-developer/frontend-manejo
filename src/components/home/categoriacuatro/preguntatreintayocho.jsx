...
export default function PreguntaTreintayOchoScreen ({navigation}) {
    ...
    const siguiente_pregunta = () => {
        if (opcion === ''){
            ...
            navigation.navigate ('PreguntaCatCuatroTreintayNueveScreen')
        }
    }

    return (
        <GestureHandlerRootView style={{flex: 1, width: '100%'}}>
            <BarraSuperior navigation={navigation} nro_pregunta={38}  categoria={'CATEGORÍA 4 - A3A'}/>

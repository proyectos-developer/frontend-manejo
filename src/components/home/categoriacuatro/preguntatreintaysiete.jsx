...
export default function PreguntaTreintaySieteScreen ({navigation}) {
    ...
    const siguiente_pregunta = () => {
        if (opcion === ''){
            ...
            navigation.navigate ('PreguntaCatCuatroTreintayOchoScreen')
        }
    }

    return (
        <GestureHandlerRootView style={{flex: 1, width: '100%'}}>
            <BarraSuperior navigation={navigation} nro_pregunta={37} categoria={'CATEGORÍA 4 - A3A'}/>

...
export default function CategoriaDosRespuestas ({navigation}) {
    ...
    return (
        <GestureHandlerRootView style={{flex: 1, width: '100%'}}>
            <BarraSuperiorRespuestas navigation={navigation} categoria={'CATEGORÍA 2 - B2B'} nro_categoria={nro_categoria} correcta={correcta_usuario}/>

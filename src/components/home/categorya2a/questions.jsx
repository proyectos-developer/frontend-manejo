...
export default function A2aCategoryQuestions ({navigation}) {
    ...
    */
    useEffect (() => {
        if (isFocused){
            dispatch(questionsdata(questionsConstants({}, false, id_question, 'a2a_category').get_question))
        }
    }, [isFocused])
    ...
    */
    ...
    const next_question = () => {
        if (option === ''){
            ...
            dispatch(questionsdata(questionsConstants({}, false, parseFloat(id_question) + 1, 'a2a_category').get_question))
        }
    }
    ...
    return (
        <GestureHandlerRootView style={{flex: 1, width: '100%'}}>
            ...
            <TopBar navigation={navigation} categoria={'CATEGORÍA 3 - A2A'} nro_categoria={'3'}/>

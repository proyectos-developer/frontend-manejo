...
export default function CategoriaTresPreguntas ({navigation}) {
    ...
    const repetir_examen = () => {
        if (opcion !== ''){
            ...
            dispatch(preguntasdata(preguntasConstants({}, false, id_inicial, 'preguntas_categoria_tres').get_pregunta))
        }
    }

    return (
        <GestureHandlerRootView style={{flex: 1, width: '100%'}}>
            <BarraSuperior navigation={navigation} categoria={'CATEGORÍA 3 - A2A'} nro_categoria={'preguntas_categoria_tres'}/>

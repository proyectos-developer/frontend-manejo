...
export default function A3bCategoryQuestions ({navigation}) {
    ...
    */
    useEffect (() => {
        if (isFocused){
            dispatch(questionsdata(questionsConstants({}, false, id_question, 'a3b_category').get_question))
        }
    }, [isFocused])
    ...
    */
    ...
    const next_question = () => {
        if (option === ''){
            ...
            dispatch(questionsdata(questionsConstants({}, false, parseFloat(id_question) + 1, 'a3b_category').get_question))
        }
    }
    ...
    return (
        <GestureHandlerRootView style={{flex: 1, width: '100%'}}>
            ...
            <TopBar navigation={navigation} categoria={'CATEGORÍA 5 - A3B'} nro_categoria={'5'}/>

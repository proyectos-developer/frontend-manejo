...
import {clinicasdata} from '../../redux/slice/clinicasdata';
import {clinicasConstants} from '../../redux/uri/clinicas-constants'

export default function ExamenMedicoScreen ({navigation}) {

    const dispatch = useDispatch()
    const isFocused = useIsFocused()

    const [lista_clincias, setListaClinicas] = useState([])
